...
# 数据集信息
# 数据集
DATASET_NAME="lucaone_virus"
# 版本号
DATASET_TYPE="v1.0"
# 预训练任务类别
TASK_TYPE="token_level"
# 预训练任务
PRETRAIN_TASK_LEVEL_NAME="gene_mask,prot_mask"
...
cd ..
python -W ignore -m torch.distributed.launch --nnodes 1 --node_rank 0 --nproc_per_node=$nproc_per_node \
       run.py \
       --time_str $time_str \
       ...
       --gene_type_label_filepath ../label/$DATASET_NAME/$DATASET_TYPE/lucaone_virus_gene_type_span_level_label.txt \
       --prot_homo_label_filepath ../label/$DATASET_NAME/$DATASET_TYPE/lucaone_virus_prot_homo_span_level_label.txt \
       --prot_site_label_filepath ../label/$DATASET_NAME/$DATASET_TYPE/lucaone_virus_prot_site_span_level_label.txt \
       --prot_domain_label_filepath ../label/$DATASET_NAME/$DATASET_TYPE/lucaone_virus_prot_domain_span_level_label.txt \
       --gene_taxonomy_label_filepath ../label/$DATASET_NAME/$DATASET_TYPE/lucaone_virus_gene_taxonomy_seq_level_label.txt \
       --prot_taxonomy_label_filepath ../label/$DATASET_NAME/$DATASET_TYPE/lucaone_virus_prot_taxonomy_seq_level_label.txt \
       --prot_keyword_label_filepath ../label/$DATASET_NAME/$DATASET_TYPE/lucaone_virus_prot_keyword_seq_level_label.txt \
       ...
       --global_total_loss 1638124.442100525 \
       --cur_epoch_loss 1638124.442100525 \
       --trained_checkpoint 1400000 \
       --model_dirpath ../models/lucaone_virus/v1.0/token_level/lucaone_virus/20250113063529/checkpoint-step1400000
