...
@tel: 137****6540
@datetime: 2024/8/6 09:36
@project: LucaVirus
@file: lucavirus_prot_label_fill_udf.py
@desc: label的json中不存在的label字段进行空填充，避免后续的算法出错
"""
import json
        ...
        if label is not None and len(label) > 0:
            ...
            if "span_level" not in obj:
                ...
                if "prot_site" not in obj["span_level"] or obj["span_level"]["prot_site"] is None:
                    obj["span_level"]["prot_site"] = []
                if "prot_domain" not in obj["span_level"] or obj["span_level"]["prot_domain"] is None:
                    obj["span_level"]["prot_domain"] = []
