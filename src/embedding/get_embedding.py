...
try:
    ...
    from utils import set_seed, to_device, get_labels, get_parameter_number, gene_seq_replace, \
        download_trained_checkpoint_lucavirus, clean_seq_luca, available_gpu_id, calc_emb_filename_by_seq_id, seq_type_is_match_seq
...
def encoder(
    ...
    if args_info["model_type"] in ["lucavirus_longformer"]:
...
def get_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="lucavirus",
        choices=["lucavirus", "lucavirus-gene", "lucavirus-prot", "lucavirus-mask"],
        help="the llm type"
    )
