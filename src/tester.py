...
sys.path.append("../src")
try:
    from utils import to_device, concat_output, calc_avg_loss, \
        calc_eval_test_loss, process_outputs, eval_metrics, print_shape, metrics_merge, print_batch, writer_info_tb
    ...
    from src.utils import to_device, concat_output, calc_avg_loss, \
        calc_eval_test_loss, process_outputs, eval_metrics, print_shape, metrics_merge, print_batch, writer_info_tb
