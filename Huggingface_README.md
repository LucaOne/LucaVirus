...
tags:
- LucaVirus
- Biological Foundation Model for Virus
...
Please refer to the `huggingface` branch of LucaVirus: https://github.com/LucaOne/LucaVirus.
...
# model_id
model_id = "LucaGroup/LucaVirus-default-step3.8M"
...
```
## Github
For long sequence embedding or using LucaVirus for downstream tasks, please refer to the git repository:

https://github.com/LucaOne/LucaVirus,       
https://github.com/LucaOne/LucaVirusTaks